...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mateřská škola Josefa Gočára" },
      { name: "description", content: "Mateřská škola Josefa Gočára v centru Hradce Králové." },
      { property: "og:site_name", content: "Mateřská škola Josefa Gočára" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { property: "og:title", content: "Mateřská škola Josefa Gočára" },
      { name: "twitter:title", content: "Mateřská škola Josefa Gočára" },
