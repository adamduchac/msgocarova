          ...
          {links.map((l, i) => {
            ...
            return (
              <a
                key={l.href}
                href={l.href}
                className="reveal-up group flex items-center gap-4 rounded-2xl border border-border/70 bg-card px-5 py-4 transition-[box-shadow,transform,border-color] duration-[250ms] ease-out hover:-translate-y-0.5 hover:border-border hover:shadow-[0_14px_30px_-18px_rgba(16,15,16,0.18)]"
